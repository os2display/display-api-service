...
final class Version20260506215847 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $table->addColumn('id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('tenant_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('feed_source_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('version', 'integer', ['notnull' => true, 'default' => 1]);
        $table->addColumn('created_at', 'datetime_immutable', ['notnull' => true]);
        $table->addColumn('modified_at', 'datetime_immutable', ['notnull' => true]);
        $table->addColumn('created_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('modified_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('configuration', 'json', ['notnull' => false]);
        $table->addColumn('changed', 'boolean', ['notnull' => true]);
        $table->addColumn('relations_checksum', 'json', ['notnull' => true, 'default' => '{}']);
        ...
        $table->addColumn('created_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('modified_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('feed_type', 'string', ['length' => 255, 'notnull' => true]);
        $table->addColumn('secrets', 'json', ['notnull' => false]);
        $table->addColumn('supported_feed_output_type', 'string', ['length' => 255, 'notnull' => true]);
        $table->addColumn('title', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('description', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('changed', 'boolean', ['notnull' => true]);
        $table->addColumn('relations_checksum', 'json', ['notnull' => true, 'default' => '{}']);
        $table->setPrimaryKey(['id']);
        ...
        $table->addColumn('modified_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('configuration', 'json', ['notnull' => false]);
        $table->addColumn('implementation_class', 'string', ['length' => 255, 'notnull' => true]);
        $table->setPrimaryKey(['id']);
        ...
        $table->addColumn('license', 'string', ['length' => 255, 'notnull' => false, 'default' => '']);
        $table->addColumn('width', 'integer', ['notnull' => true, 'default' => 0]);
        $table->addColumn('height', 'integer', ['notnull' => true, 'default' => 0]);
        $table->addColumn('size', 'integer', ['notnull' => true, 'default' => 0]);
        $table->addColumn('mime_type', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('sha', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('title', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('description', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('changed', 'boolean', ['notnull' => true]);
        $table->addColumn('relations_checksum', 'json', ['notnull' => true, 'default' => '{}']);
        ...
        $table->addColumn('created_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('modified_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('is_campaign', 'boolean', ['notnull' => true]);
        $table->addColumn('published_from', 'datetime', ['notnull' => false]);
        $table->addColumn('published_to', 'datetime', ['notnull' => false]);
        $table->addColumn('title', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('description', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('changed', 'boolean', ['notnull' => true]);
        $table->addColumn('relations_checksum', 'json', ['notnull' => true, 'default' => '{}']);
        ...
        $table->addColumn('playlist_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('tenant_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        ...
        $table->addColumn('tenant_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('playlist_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('screen_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('region_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('version', 'integer', ['notnull' => true, 'default' => 1]);
        $table->addColumn('created_at', 'datetime_immutable', ['notnull' => true]);
        $table->addColumn('modified_at', 'datetime_immutable', ['notnull' => true]);
        $table->addColumn('created_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        ...
        $table->addColumn('tenant_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('playlist_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('slide_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('version', 'integer', ['notnull' => true, 'default' => 1]);
        $table->addColumn('created_at', 'datetime_immutable', ['notnull' => true]);
        $table->addColumn('modified_at', 'datetime_immutable', ['notnull' => true]);
        $table->addColumn('created_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        ...
        $table->addColumn('refresh_token', 'string', ['length' => 128, 'notnull' => true]);
        $table->addColumn('username', 'string', ['length' => 255, 'notnull' => true]);
        $table->addColumn('valid', 'datetime', ['notnull' => true]);
        $table->setPrimaryKey(['id']);
        ...
        $table->addColumn('created_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('modified_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('rrule', 'rrule', ['length' => 255, 'notnull' => true]);
        $table->addColumn('duration', 'integer', ['notnull' => true]);
        $table->setPrimaryKey(['id']);
        ...
        $table->addColumn('id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('tenant_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('screen_layout_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('version', 'integer', ['notnull' => true, 'default' => 1]);
        $table->addColumn('created_at', 'datetime_immutable', ['notnull' => true]);
        $table->addColumn('modified_at', 'datetime_immutable', ['notnull' => true]);
        $table->addColumn('created_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('modified_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('size', 'integer', ['notnull' => true, 'default' => 0]);
        $table->addColumn('resolution', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('orientation', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('location', 'string', ['length' => 255, 'notnull' => false, 'default' => '']);
        $table->addColumn('enable_color_scheme_change', 'boolean', ['notnull' => false]);
        $table->addColumn('title', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('description', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('changed', 'boolean', ['notnull' => true]);
        $table->addColumn('relations_checksum', 'json', ['notnull' => true, 'default' => '{}']);
        ...
        $table->addColumn('id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('tenant_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('campaign_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('screen_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('version', 'integer', ['notnull' => true, 'default' => 1]);
        $table->addColumn('created_at', 'datetime_immutable', ['notnull' => true]);
        $table->addColumn('modified_at', 'datetime_immutable', ['notnull' => true]);
        ...
        $table->addColumn('screen_group_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('screen_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        ...
        $table->addColumn('created_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('modified_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('grid_rows', 'integer', ['notnull' => true, 'default' => 0]);
        $table->addColumn('grid_columns', 'integer', ['notnull' => true, 'default' => 0]);
        $table->addColumn('title', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('description', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('changed', 'boolean', ['notnull' => true]);
        $table->addColumn('relations_checksum', 'json', ['notnull' => true, 'default' => '{}']);
        ...
        $table->addColumn('id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('screen_layout_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => false]);
        $table->addColumn('version', 'integer', ['notnull' => true, 'default' => 1]);
        $table->addColumn('created_at', 'datetime_immutable', ['notnull' => true]);
        $table->addColumn('modified_at', 'datetime_immutable', ['notnull' => true]);
        $table->addColumn('created_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('modified_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('title', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('grid_area', 'json', ['notnull' => true]);
        ...
        $table->addColumn('screen_layout_regions_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('tenant_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        ...
        $table->addColumn('id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('tenant_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('screen_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => false]);
        $table->addColumn('version', 'integer', ['notnull' => true, 'default' => 1]);
        $table->addColumn('created_at', 'datetime_immutable', ['notnull' => true]);
        $table->addColumn('modified_at', 'datetime_immutable', ['notnull' => true]);
        $table->addColumn('created_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('modified_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('username', 'string', ['length' => 180, 'notnull' => true]);
        $table->addColumn('roles', 'json', ['notnull' => true]);
        $table->addColumn('release_timestamp', 'integer', ['notnull' => false]);
        $table->addColumn('release_version', 'string', ['length' => 255, 'notnull' => false]);
        $table->addColumn('latest_request', 'datetime', ['notnull' => false]);
        $table->addColumn('client_meta', 'json', ['notnull' => false]);
        $table->setPrimaryKey(['id']);
        ...
        $table->addColumn('id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('tenant_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('template_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('theme_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => false]);
        $table->addColumn('feed_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => false]);
        $table->addColumn('version', 'integer', ['notnull' => true, 'default' => 1]);
        $table->addColumn('created_at', 'datetime_immutable', ['notnull' => true]);
        $table->addColumn('modified_at', 'datetime_immutable', ['notnull' => true]);
        $table->addColumn('created_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        ...
        $table->addColumn('content', 'json', ['notnull' => false]);
        $table->addColumn('template_options', 'json', ['notnull' => false]);
        $table->addColumn('published_from', 'datetime', ['notnull' => false]);
        $table->addColumn('published_to', 'datetime', ['notnull' => false]);
        $table->addColumn('title', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('description', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        ...
        $table->addColumn('slide_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('media_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        ...
        $table->addColumn('modified_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('title', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('icon', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('resources', 'json', ['notnull' => true]);
        $table->addColumn('description', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('changed', 'boolean', ['notnull' => true]);
        $table->addColumn('relations_checksum', 'json', ['notnull' => true, 'default' => '{}']);
        $table->setPrimaryKey(['id']);
        ...
        $table->addColumn('created_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('modified_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('tenant_key', 'string', ['length' => 25, 'notnull' => true]);
        $table->addColumn('fallback_image_url', 'string', ['length' => 255, 'notnull' => false]);
        $table->addColumn('title', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('description', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->setPrimaryKey(['id']);
        ...
        $table->addColumn('id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('tenant_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('logo_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => false]);
        $table->addColumn('version', 'integer', ['notnull' => true, 'default' => 1]);
        $table->addColumn('created_at', 'datetime_immutable', ['notnull' => true]);
        $table->addColumn('modified_at', 'datetime_immutable', ['notnull' => true]);
        $table->addColumn('created_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('modified_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('css_styles', 'text', ['notnull' => true]);
        $table->addColumn('title', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('description', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('changed', 'boolean', ['notnull' => true]);
        $table->addColumn('relations_checksum', 'json', ['notnull' => true, 'default' => '{}']);
        ...
        $table->addColumn('created_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('modified_by', 'string', ['length' => 255, 'notnull' => true, 'default' => '']);
        $table->addColumn('provider_id', 'string', ['length' => 255, 'notnull' => true]);
        $table->addColumn('email', 'string', ['length' => 180, 'notnull' => true]);
        $table->addColumn('full_name', 'string', ['length' => 255, 'notnull' => true]);
        $table->addColumn('password', 'string', ['length' => 255, 'notnull' => true]);
        $table->addColumn('provider', 'string', ['length' => 255, 'notnull' => true]);
        $table->addColumn('user_type', 'string', ['length' => 255, 'notnull' => true]);
        $table->setPrimaryKey(['id']);
        ...
        $table->addColumn('code_expire', 'datetime_immutable', ['notnull' => true]);
        $table->addColumn('username', 'string', ['length' => 255, 'notnull' => true]);
        $table->addColumn('roles', 'json', ['notnull' => true]);
        $table->setPrimaryKey(['id']);
        ...
        $table->addColumn('id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('user_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('tenant_id', 'ulid', ['length' => 16, 'fixed' => true, 'notnull' => true]);
        $table->addColumn('version', 'integer', ['notnull' => true, 'default' => 1]);
        $table->addColumn('created_at', 'datetime_immutable', ['notnull' => true]);
        $table->addColumn('modified_at', 'datetime_immutable', ['notnull' => true]);
