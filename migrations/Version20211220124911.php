 ...
 */
final class Version20211220124911 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE slide ADD feed_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:ulid)\', DROP feed');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE slide ADD feed VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP feed_id');
    }
}
