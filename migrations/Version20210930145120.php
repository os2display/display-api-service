 ...
 */
final class Version20210930145120 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE media (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', file_path VARCHAR(255) DEFAULT NULL, license VARCHAR(255) DEFAULT \'\', width INT DEFAULT 0 NOT NULL, height INT DEFAULT 0 NOT NULL, size INT DEFAULT 0 NOT NULL, mime_type VARCHAR(255) DEFAULT \'\' NOT NULL, sha VARCHAR(255) DEFAULT \'\' NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, title VARCHAR(255) DEFAULT \'\' NOT NULL, description VARCHAR(255) DEFAULT \'\' NOT NULL, modified_by VARCHAR(255) DEFAULT \'\' NOT NULL, created_by VARCHAR(255) DEFAULT \'\' NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE playlist_screen_region (playlist_id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', screen_id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', region_id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', INDEX IDX_6869486A6BBD148 (playlist_id), INDEX IDX_6869486A41A67722 (screen_id), INDEX IDX_6869486A98260155 (region_id), PRIMARY KEY(playlist_id, screen_id, region_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
