...
final class Version20241125085559 extends AbstractMigration
{
    ...
    {
        $this->addSql('UPDATE feed_source SET feed_type = "App\\\\Feed\\\\CalendarApiFeedType" WHERE feed_type LIKE "App\\\\Feed\\\\SourceType\\\\Calendar\\\\CalendarApiFeedType"');
        $this->addSql('UPDATE feed_source SET feed_type = "App\\\\Feed\\\\EventDatabaseApiFeedType" WHERE feed_type LIKE "App\\\\Feed\\\\SourceType\\\\EventDatabase\\\\EventDatabaseApiFeedType"');
        $this->addSql('UPDATE feed_source SET feed_type = "App\\\\Feed\\\\KobaFeedType" WHERE feed_type LIKE "App\\\\Feed\\\\SourceType\\\\Koba\\\\KobaFeedType"');
        $this->addSql('UPDATE feed_source SET feed_type = "App\\\\Feed\\\\NotifiedFeedType" WHERE feed_type LIKE "App\\\\Feed\\\\SourceType\\\\Notified\\\\NotifiedFeedType"');
        $this->addSql('UPDATE feed_source SET feed_type = "App\\\\Feed\\\\RssFeedType" WHERE feed_type LIKE "App\\\\Feed\\\\SourceType\\\\Rss\\\\RssFeedType"');
        $this->addSql('UPDATE feed_source SET feed_type = "App\\\\Feed\\\\SparkleIOFeedType" WHERE feed_type LIKE "App\\\\Feed\\\\SourceType\\\\SparkleIO\\\\SparkleIOFeedType"');
    }
}
